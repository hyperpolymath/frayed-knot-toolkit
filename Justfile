...
project := "frayed-knot-toolkit"
OWNER := "hyperpolymath"
REPO := "frayed-knot-toolkit"
version := "0.1.0"
...
verify-template:
    ...
    if grep -q 'frayed-knot-toolkit' Justfile 2>/dev/null; then
        echo "⚠ Justfile still references 'frayed-knot-toolkit' — update project name"
        FOUND=1
    fi
...
container-init:
    ...
    if [ ! -d "container" ]; then
        ...
        echo "This repo may not have been created from frayed-knot-toolkit."
        exit 1
    fi
...
doctor:
    @echo "Running diagnostics for frayed-knot-toolkit..."
...
help-me:
    @echo "=== frayed-knot-toolkit Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/frayed-knot-toolkit/issues/new"
    @echo ""
